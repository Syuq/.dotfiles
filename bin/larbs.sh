...
# TAT's Auto Rice Boostrapping Script (LARBS)
# by TAT Syuq <tatd.wine@gmail.com>
# License: GNU GPLv3

### OPTIONS AND VARIABLES ###

dotfilesrepo="https://github.com/Syuq/.dotfiles.git"
progsfile="https://raw.githubusercontent.com/Syuq/LARBS/master/static/progs.csv"
aurhelper="yay"
repobranch="master"
export TERM=ansi
...
welcomemsg() {
	whiptail --title "Welcome!" \
		--msgbox "Welcome to Syuq's Auto-Rice Bootstrapping Script!\\n\\nThis script will automatically install a fully-featured Linux desktop, which I use as my main machine.\\n\\n-Syuq" 10 60
